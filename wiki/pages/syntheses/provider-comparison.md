...
- Storage is the physical fix ([[claim-storage-physical-fix]])
- Transmission is the immediate blocker ([[claim-transmission-immediate-blocker]])
- Domestic use > export worship ([[claim-domestic-led-strategy]])
- India is decisive ([[claim-india-decisive-actor]])
- Governance is binding ([[claim-governance-binding]])
