...
The separate NEA solar procurement dataset contains 63 letter-of-intent award records totalling **960 MW**. These records establish an award event. They do not by themselves establish PPA execution, financing, construction or operation. V1 therefore labels this cohort **award-only / delivery status unknown**, rather than calling all 960 MW a current construction pipeline.
