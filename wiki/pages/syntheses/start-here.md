...
If you are arriving with a specific job to do, start with the reader doors: [[for-policymakers]] for decision briefs and policy options, and [[for-journalists]] for tracing headline numbers back to sources.
...
- [[seasonal-mismatch]] - why Nepal can export electricity in the monsoon and import in the dry season.
- [[firm-power]] - why dependable timing matters more than nameplate megawatts.
- [[claim-transmission-immediate-blocker]] - why grid delivery is now an immediate constraint on monetizing generation.
- [[storage-deficit]] - why Nepal has very little seasonal storage relative to its hydropower ambition.
- [[solar-hydro-complementarity]] - why solar is valuable even though hydropower dominates the installed electricity mix.
- [[india-energy-relationship]] - how India's market rules, corridors, and approvals shape export options.
- [[downstream-river-geopolitics]] - how Nepal's rivers connect into larger downstream systems.
...
- Open [[data-map-layer-labels]] when you want to know what each map layer means.
- Use [[data-layer-nepal-tributaries]] for basin and river context.
- Use [[data-layer-hydropower-operating]] to separate operating projects from the wider licensing pipeline.
- Use [[data-layer-transmission-connected-traced-network]] to see the public-facing transmission corridor layer.
- Use [[data-layer-storage-shortlist]] for storage and storage-like projects with dry-season system value.
- Use [[data-layer-solar-plants-nea-awards]] and [[data-layer-solar-ghi-zones]] for solar assets and resource geography.
...
Some project pages are registry-backed project records. They preserve capacity, status, location, and map coverage even when there is not yet enough public material for a fuller narrative article.
