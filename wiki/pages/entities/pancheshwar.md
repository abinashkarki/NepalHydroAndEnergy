...
images:
  - src: pancheshwar/mahakali-river-came-from-api-mountain-at-darchula.jpg
    caption: Mahakali River (Sharda River) came from Api Mountain at Darchula district, Nepal
    credit: Mahendra Jung Thapa
    license: CC BY-SA 4.0
    source_url: "https://commons.wikimedia.org/wiki/File%3AMahakali_river_Came_from_Api_Mountain_At_Darchula.jpg"
---
...
| River | Mahakali / Sharda ([[mahakali-basin]]) |
...
The DPR's unapproved status means none of these figures are bankable. Until the Joint Expert Group finalizes and both cabinets approve the report, procurement cannot begin.
...
Pancheshwar is not unique — several Nepal-India joint projects are stuck on similar valuation questions:
- **Saptakoshi High Dam**: JTE meetings stalled; 17th JTE was October 2023
- **Sunkoshi Storage**: similar bilateral design and benefit-sharing stalemates
- **Naumure (West Rapti)**: not yet bilateral but downstream impacts with India are foreseeable

The pattern is systemic: India-Nepal water cooperation lacks a standardized framework for valuing and sharing non-electricity benefits. Every project becomes a standalone negotiation, and every standalone negotiation stalls on the same question.

## International Comparison: Itaipu

| Parameter | Itaipu (Brazil/Paraguay) | Pancheshwar (Nepal/India) |
|-----------|--------------------------|---------------------------|
| Treaty signed | 1973 | 1996 |
...
The critical difference is governance architecture. Itaipu showed that a single joint entity with clear commercial mandate can deliver. Pancheshwar shows that a treaty without an implementing entity, without financing commitments, and without a mechanism for valuing non-power benefits cannot.
...
Pancheshwar is the ultimate case study for [[hydro-geopolitics]]. It shows how bilateral treaty structures, domestic politics on both sides, the difficulty of valuing non-electricity benefits, and the absence of a single executing entity can prevent even the most strategically obvious projects from materializing.

The comparison with [[budhigandaki]] — a 1,200 MW domestically-controlled storage project that is actually advancing — supports the [[domestic-led-hydro-strategy]] thesis: projects that Nepal can control unilaterally are slow, but projects that require bilateral consensus may be impossible.

## Related

- [[mahakali-basin]] — the river
- [[india-energy-relationship]] — the bilateral context
- [[hydro-geopolitics]] — the analytical frame
- [[budhigandaki]] — the domestically-controlled storage counterpoint
- [[karnali-chisapani]] — the other mega-project in the same governance class
- [[domestic-led-hydro-strategy]] — the policy thesis Pancheshwar supports
