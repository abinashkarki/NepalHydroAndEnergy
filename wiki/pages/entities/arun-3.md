...
### Engineering
Arun-3 is designed as a peaking RoR plant — 3.4 hours of full rated output per day, delivered through an underground powerhouse with four Francis turbines. This means its 900 MW nameplate translates into a much smaller day-long energy contribution than its capacity suggests. Compare with [[upper-tamakoshi]] (456 MW continuous RoR) for the contrast in fleet-shape implications.
...
### Governance
SJVN, an Indian state utility, develops, owns, and operates the project through its subsidiary SAPDC. This is the reference case for India-developed export-first hydropower in Nepal — a structure that the [[domestic-led-hydro-strategy]] thesis argues against for strategic capacity control.

| Parameter | Value |
|-----------|-------|
| Developer | SJVN Arun-3 Power Development Company (SAPDC) |
| Lead financier | SJVN (Indian state utility) |
